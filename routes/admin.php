...
Route::group(
    ...
    function () {
        ...
        Route::get('countries/{country}/show', 'CountryController@show')->name('countries.show');
        Route::resource('countries', 'CountryController', [
            'only' => ['store', 'update', 'destroy'],
        ]);

        Route::post('countries/batch_action', 'CountryController@batchAction')->name('countries.batch_action');
    }
);
