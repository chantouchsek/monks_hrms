    ...
    <ul class="nav">
        ...
        <li class="nav-item">
            <a class="nav-link" href="{{ route('admin.countries.index') }}">
                <i class="nav-icon icon-drop"></i> Countries
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="{{ route('admin.provinces.index') }}">
                <i class="nav-icon icon-drop"></i> Provinces
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="{{ route('admin.districts.index') }}">
                <i class="nav-icon icon-drop"></i> Districts
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="{{ route('admin.communes.index') }}">
                <i class="nav-icon icon-drop"></i> Communes
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="{{ route('admin.villages.index') }}">
                <i class="nav-icon icon-drop"></i> Villages
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="typography.html">
                <i class="nav-icon icon-pencil"></i> Pagodas
            </a>
        </li>
